...
| [tufte-data-viz](skills/tufte-data-viz/) | Design & Content | [shrwnsan fork](https://github.com/shrwnsan/tufte-data-viz) of [caylent](https://github.com/caylent/tufte-data-viz) | Tufte chart principles + per-library recipes — scoped to reviewing/auditing existing chart code; dataviz generates, tufte reviews (MIT, pinned fork @ ae7ca0d — [provenance](skills/tufte-data-viz/PROVENANCE.md)) |
