...
One endpoint: token security scan. Fronted by a CLI that auto-generates the required `requestId` UUID.

```bash
node <skill-dir>/scripts/cli.mjs '{"binanceChainId":"56","contractAddress":"0x..."}'
```
